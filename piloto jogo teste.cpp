...
int main(){
	...
	int opcaoP1=0, opcaoP2=0, opcaoP3=0;
	string pressione;
	setlocale(LC_ALL, "portuguese");
	
	cout << "SEJA BEM VINDO AO JOGO" << endl;
	cout << "  EFEITO BORBOLETA\n" << endl;
	cout << "O simples bater de asas de uma borboleta no Brasil pode ocasionar um tornado no Texas...\n\n" <<endl;
 ...
 juventude e na adolescência, Evan sofreu graves traumas sexuais e psicológicos. Esses traumas
 incluem ser forçado pelo vizinho Jorge a participar de pornografia infantil ou de até mesmo
 ...
 lembra-se do ocorrido.*/
	...
	cout << "juventude e na adolescência, Evan sofreu graves traumas sexuais e psicológicos. Esses traumas" << endl;
	cout << "incluem ser forçado pelo vizinho Jorge a participar de pornografia infantil ou de até mesmo" << endl;
 ...
 amigo amputado.*/
   ...
   /*As acoes que ele toma, permite que ele retorne ao momento dos apagões e mude a linha do
...
*/
	...
	cout << "As acoes que ele toma, permite que ele retorne ao momento dos apagões e mude a linha do" << endl;
...
amada viva porém Evan está expulso da faculdade e Jorge a pessoa que obrigava Evan a fazer
pornografia é o melhor amigo de Katy na faculdade a qual Evan foi expulso.
...
Evan com seu diário em mãos volta no tempo:*/
	    ...
	    cout << "amada viva, porém Evan está expulso da faculdade e Jorge a pessoa que obrigava Evan a fazer" << endl;
	    cout << "pornografias é o melhor amigo de Katy na faculdade a qual Evan foi expulso." << endl;
	...
	cout << "Evan com seu diário em mãos pensa em volta no tempo:\n\n" << endl;
...
preso, ficando novamente longe de sua amada.*/
		...
		if (opcaoP3 == 1 || opcaoP3 == 2 ){
			...
			cout << "andando, seu amigo andando também, porem Tomy está solto, Evanfica em fúria mata Tomy e é" << endl;
		...
		/*Ao escolher essa alternativa: Jorge abusa de Katy, Evan sabendo disso mata Jorge, Evan é preso
no mesmo presídio que o assassino de seus pais Tomy.*/

        cout << "Ao escolher essa alternativa: Jorge abusa de Katy, Evan sabendo disso mata Jorge, Evan é preso" << endl;
 ...
 FIM*/
	...
	cout << "Evan dentro de sua cela, a única coisa que via a pedir era aos policiais que ao menos deixasse" << endl;
